...
//	private static final Logger logger = LoggerFactory.getLogger(StringUtils.class);
	 ...
	 * @return
	 */
	public static <T> List<T> splitParameterStringValue(String paramValue, String sep, Class<T> targetClazz){
	    return splitParameterStringValue(paramValue, sep, targetClazz, false);
	}
	
	/**
     * 该方法将字符串按照分隔符分开，并将每段字符串转成指定类型。支持String,Double,Float,Integer,Long,BigDecimal
     * 
     * @param <T>
     * @param paramValue
     * @param sep
     ...
     * @return
     */
	public static <T> List<T> splitParameterStringValue(String paramValue, String sep, Class<T> targetClazz,boolean preserveToken){
        if (paramValue == null) return null;
        
        List<T> valueList = new ArrayList<T>();
        
        String[] valueArr = preserveToken == false ? StringUtils.split(paramValue,sep):StringUtils.splitPreserveAllTokens(paramValue, sep);
	...
	private static <T> T convertToValue(String value, Class<T> targetClazz) throws Exception {
       ...
       if (targetClazz.equals(BigDecimal.class)) {
           ...
           Method method = targetClazz.getMethod("valueOf", String.class);
