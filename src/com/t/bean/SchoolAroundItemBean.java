...
public class SchoolAroundItemBean {
	...
	public SchoolAroundItemBean(){
		
	}
	
	public SchoolAroundItemBean(SchoolAroundItem a){
		this.itemId = a.getItemId();
		this.typeId = a.getTypeId();
		this.objectId = a.getObjectId();
		this.itemName = a.getItemName();
		this.itemDescription = a.getItemDescription();
		this.itemPic = a.getItemPic();
		this.itemLocation = a.getItemLocation();
		this.itemTel = a.getItemTel();
		this.itemPlus = a.getItemPlus();
